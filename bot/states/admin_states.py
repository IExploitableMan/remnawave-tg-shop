...
class AdminStates(StatesGroup):
    ...
    waiting_for_promo_traffic_gb = State()
    waiting_for_promo_discount_percentage = State()
    waiting_for_promo_discount_cap = State()
    waiting_for_promo_max_activations = State()
    waiting_for_promo_validity_days = State()
    waiting_for_promo_registration_date_mode = State()
    waiting_for_promo_min_user_registration_date = State()
    waiting_for_promo_subscription_presence_mode = State()
    waiting_for_promo_combined_discount_scope = State()
